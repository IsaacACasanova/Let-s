...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.nameLabel.text = @"Camping Trip!";
    cell.updateLabel.text = @"Let's go camping this weekend at Webb Mountain! Supposed to be beautiful weather";
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([[segue identifier] isEqualToString:@"ShowEvent"]){
       ...
       /*
        ...
        eventViewController.DetailModal = @[_Title[row], _Description[row], _Images[row]];
        */
    }
}
